...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Bouquet brush switch
        Switch bouquetSwitch = (Switch) findViewById(R.id.bouquetSwitch);
        bouquetSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                _impressionistView.setBouquet(isChecked);
            }
        });

        //Eraser brush switch
        Switch eraserSwitch = (Switch) findViewById(R.id.eraserSwitch);
        eraserSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                _impressionistView.setEraser(isChecked);
            }
        });
    ...
    public void onButtonClickSave(View v) {
        ...
        Bitmap bmap = _impressionistView.get_offScreenBitmap();
